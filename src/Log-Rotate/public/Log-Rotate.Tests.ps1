...
"@
    ...
    Context 'Behavior from flags' {
        ...
        It 'rotates a log file when forced' {
            ...
            $force = $true
            Log-Rotate -config $configFile -State $stateFile -Force:$force -ErrorAction $eaPreference #-Verbose
        ...
        It 'does not rotates a log file in debug mode' {
            Init

            $debug = $true
            Log-Rotate -config $configFile -State $stateFile -ErrorAction $eaPreference -Debug:$debug #-Verbose
        ...
        It 'does not rotates a log file when forced in debug mode ' {
            Init

            $debug = $true
            $force = $true
            Log-Rotate -config $configFile -State $stateFile -ErrorAction $eaPreference -Debug:$debug -Force:$force #-Verbose
